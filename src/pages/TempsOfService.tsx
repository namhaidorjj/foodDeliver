...
export default function TempsOfService() {
  return (
    <div className="min-h-screen flex flex-col ">
      <Header />
      <div className="flex flex-col items-center">
        <div className="flex pl-[120px] font-[22px] pt-[30px] pb-[40px] justify-start">
          <StarSVG />
          <p className="font-bold">Үйлчилгээний нөхцөл</p>
        </div>
        <div className="pl-[120px] pr-[120px] pb-[50px] text-[18px] w-[1064px]">
